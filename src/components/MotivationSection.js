...
const MotivationSection = () => {
	return (
		<div className="bg-primary-main flex flex-col lg:flex-row items-center justify-center px-10 py-32 gap-16">
			<img src={Illustration} alt="collaboration" />
			<div className="flex flex-col items-start gap-5">
				<h1 className="max-w-md text-2xl md:text-4xl font-special font-bold">
				...
				<div className="underline underline-offset-8">
					<a className="text-accent-cyan text-sm md:text-base " href="/">
						See how Fylo works
					</a>
